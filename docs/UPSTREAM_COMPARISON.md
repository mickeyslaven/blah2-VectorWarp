...
| Package distribution | No VectorWarp packages | Ten native DEB/RPM targets across Ubuntu, Debian and Fedora; release automation and one signed APT/DNF repository implementation | Fedora 44 x86-64 RPM built, inspected and replay-tested after extraction. Real format/signature fixtures and Jammy/Noble/Resolute/Trixie APT indexes pass. Debian/Pi/DragonOS selector fixtures pass, including 32-bit-userland rejection. Hosted package installation and Pi/DragonOS hardware validation remain pending. **No published repository or verified hosted release yet.** |

Hosted Ubuntu 24.04 x86-64 and ARM64 compilation, C++ unit tests and full-processor
