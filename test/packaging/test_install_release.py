...
class InstallerFailureTests(unittest.TestCase):
    ...
    def test_default_install_is_retryable_and_never_starts_a_service(self):
        ...
        self.assertIn("package upgrade hooks may restore previously running services", second.stdout)
        self.assertIn("vectorwarp help lists all commands", second.stdout)
    ...
    def test_start_web_is_explicit_and_limited_to_api(self):
        ...
        self.assertIn("package upgrade hooks may restore previously running services", result.stdout)
        self.assertIn("vectorwarp help lists all commands", result.stdout)
        log = self.log.read_text()
