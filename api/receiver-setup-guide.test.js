...
const unknown = receiverSetupGuide(base, '/opt/vectorwarp/libexec/vectorwarp-receiver-helper', {platform: 'linux'});
...
const stopped = receiverSetupGuide({...base, dependencies: {state: 'installed'},
  managedService: {state: 'stopped'}}, '/opt/vectorwarp/libexec/vectorwarp-receiver-helper', {platform: 'linux'});
...
const running = receiverSetupGuide({...base, dependencies: {state: 'installed'},
  managedService: {state: 'running'}}, '/opt/vectorwarp/libexec/vectorwarp-receiver-helper', {platform: 'linux'});
assert.ok(!running.some(step => step.command?.endsWith('enroll-service RspDuo')));
const usrp = receiverSetupGuide({...base, type: 'Usrp',
  dependencies: {state: 'missing'}}, '/opt/vectorwarp/libexec/vectorwarp-receiver-helper', {platform: 'linux'});
