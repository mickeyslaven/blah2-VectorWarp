...
public:
  ...
  Map<Complex> *process_borrowed(const Complex* rotatedReference,
    uint32_t referenceSamples, const Complex* filteredSurveillance,
    uint32_t surveillanceSamples, int32_t clutterDelayMin);
...
private:
  Map<Complex> *process_impl(const std::deque<Complex>* originalReference,
    const Complex* rawReference, uint32_t rawReferenceSamples,
    IqData* surveillanceOwner, const Complex* rawSurveillance,
    uint32_t rawSurveillanceSamples, const Complex* rotatedReference,
    const Complex* filteredSurveillance, uint32_t fullSamples,
